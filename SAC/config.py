...
PROGRESS_SCALE = 1000.0
PROGRESS_V_COEF = 5.0
CENTERLINE_REWARD_COEF = 0.6
CENTERLINE_REWARD_WINDOW = 0.75
BACKWARD_SPEED_THRESH = 0.25
BACKWARD_PENALTY_COEF = 2.0
CIRCLE_TURN_RATE_THRESH = 1.5
CIRCLE_FORWARD_SPEED_THRESH = 1.0
CIRCLE_PENALTY_COEF = 0.5
